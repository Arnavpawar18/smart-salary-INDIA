...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('total_declared_deductions', sa.Numeric(precision=18, scale=2), server_default='0.00', nullable=False),
        sa.Column('total_verified_deductions', sa.Numeric(precision=18, scale=2), server_default='0.00', nullable=False),
        sa.Column('projected_annual_liability', sa.Numeric(precision=18, scale=2), server_default='0.00', nullable=False),
        sa.Column('planned_monthly_withholding', sa.Numeric(precision=18, scale=2), server_default='0.00', nullable=False),
    ...
    op.create_index(op.f('ix_tax_declaration_items_declaration_id'), 'tax_declaration_items', ['declaration_id'], unique=False)
    ...
    op.create_index(op.f('ix_statutory_compliance_events_organization_id'), 'statutory_compliance_events', ['organization_id'], unique=False)
